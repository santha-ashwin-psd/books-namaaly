...
<div class="list-page">
  ...
  <div class="bk-stat-grid">
    ...
    <div class="bk-stat-card"><div class="bk-stat-content"><div><div class="bk-stat-label">Avg Buying Rate</div><div class="bk-stat-value" style="font-size:16px">{{ fmt(avgBuyingRate) }}</div></div><div class="bk-stat-icon" style="background:#fef3c7;color:#d97706"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3h18v4H3z"/><path d="M5 7v13h14V7"/><path d="M9 11h6"/></svg></div></div></div>
...
// ── Variants ──
const variantAttrs   = ref([]);   // [{ attribute, valuesText }] — seeded on edit, preserved on save
