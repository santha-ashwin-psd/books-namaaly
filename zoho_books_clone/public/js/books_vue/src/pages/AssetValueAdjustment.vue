...
<div class="list-page">
  ...
  <div class="sales-toolbar">
    ...
    <div class="sales-actions">
      ...
      <button class="sales-btn-primary" @click="openAdd"><span v-html="icon('plus',13)"></span> New Adjustment</button>
    </div>
  </div>
            ...
            <td colspan="9" class="bk-empty-state">
              <div class="bk-empty-inner">
                ...
                <template v-else>
                  ...
                  <button class="bk-empty-btn" @click="openAdd"><span v-html="icon('plus',13)"></span> New Adjustment</button>
                </template>
              </div>
            </td>
          </tr>
      ...
      <div class="inv-drawer-panel is-add">
        ...
        <div class="inv-dfooter">
          ...
          <template v-else-if="adj.docstatus===1">
            ...
            <button class="add-btn-cancel" style="color:#dc2626" :disabled="cancelling" @click="cancelAdjustment">
